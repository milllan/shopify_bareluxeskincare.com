...
if (!customElements.get("m-hero")) {
  class MHero extends HTMLElement {
    constructor() {
      super();
    }
    connectedCallback() {
      const bg = this.querySelector('.sf-hero__bg');
      if (!bg) return;
    ...
    _initBackground(bg) {
      ...
      const parallaxEnabled = this.dataset.parallax === 'true';
  ...
  customElements.define('m-hero', MHero);
}
}();
/******/ })()
;