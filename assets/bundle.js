...
const getProductInstances = query => {
  ...
  return MinimogTheme.Products.productInstances.filter(pro => {
...
/* provided dependency */ var IconPlus_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var ProductPrices_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var ProductPrices_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var ProductTitle_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var ProductTitle_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var VariantSelect_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var VariantSelect_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var CheckboxSelect_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var CheckboxSelect_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var QuantitySelector_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var Product_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var DiscountNode_createElement = __webpack_require__(6295)["Z"];
...
/* provided dependency */ var Layout_createElement = __webpack_require__(6295)["Z"];
/* provided dependency */ var Layout_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var Layout_i18n = __webpack_require__(7345)["Z"];
...
/* provided dependency */ var helpers_MinimogTheme = __webpack_require__(4558)["LE"];
...
const updateCartAttributes = offer => {
  return new Promise((resolve, reject) => {
    try {
      ...
      const {
        attributes = {}
      } = ((_MinimogTheme = helpers_MinimogTheme) === null || _MinimogTheme === void 0 ? void 0 : (_MinimogTheme$Cart = _MinimogTheme.Cart) === null || _MinimogTheme$Cart === void 0 ? void 0 : _MinimogTheme$Cart.cart) || {};
      let {
        _foxCartDiscounts
      } = attributes;
      let newAttributes = [];
...
/* provided dependency */ var bundle_createElement = __webpack_require__(6295)["Z"];
/* provided dependency */ var bundle_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var bundle_i18n = __webpack_require__(7345)["Z"];
/* provided dependency */ var bundle_MinimogTheme = __webpack_require__(4558)["LE"];
    ...
    (0,defineProperty/* default */.Z)(this, "init", async () => {
      try {
        ...
        const promises = this.domNodes.productForms.map(async form => {
          var _prodInstance$product;
          const prodInstance = new product_Product(form, {
            autoInit: false
          });
          await prodInstance.init();
          const isMain = bundle_MinimogSettings.productHandle === (prodInstance === null || prodInstance === void 0 ? void 0 : (_prodInstance$product = prodInstance.productData) === null || _prodInstance$product === void 0 ? void 0 : _prodInstance$product.handle);
        ...
        handler: () => {
          ...
          fetch('/cart/add.js', config).then(async res => {
            ...
            if (!bundle_MinimogSettings.use_ajax_atc) {
              ...
              const cartRoute = ((_MinimogSettings$rout = bundle_MinimogSettings.routes) === null || _MinimogSettings$rout === void 0 ? void 0 : _MinimogSettings$rout.cart) || '/cart';
