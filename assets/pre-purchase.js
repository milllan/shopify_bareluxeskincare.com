...
/* provided dependency */ var PrePurchase_MinimogTheme = __webpack_require__(4558)["LE"];
/* provided dependency */ var PrePurchase_createElement = __webpack_require__(6295)["Z"];
/* provided dependency */ var PrePurchase_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var MinimogStrings = __webpack_require__(4558)["rZ"];
/* provided dependency */ var PrePurchase_i18n = __webpack_require__(7345)["Z"];
...
function PrePurchase_PrePurchase(_ref) {
  ...
  const {
    item_count,
    total_price
  } = (_MinimogTheme = PrePurchase_MinimogTheme) === null || _MinimogTheme === void 0 ? void 0 : _MinimogTheme.Cart.cart;
  const {
    discount,
    active_discount
  } = settings;
...
/* provided dependency */ var pre_purchase_MinimogSettings = __webpack_require__(4558)["GQ"];
/* provided dependency */ var pre_purchase_MinimogEvents = __webpack_require__(4558)["s0"];
/* provided dependency */ var pre_purchase_MinimogTheme = __webpack_require__(4558)["LE"];
/* provided dependency */ var pre_purchase_createElement = __webpack_require__(6295)["Z"];
...
class PrePurchase {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "init", async () => {
      ...
      (_MinimogEvents$subscr = (_MinimogEvents = pre_purchase_MinimogEvents).subscribe) === null || _MinimogEvents$subscr === void 0 ? void 0 : _MinimogEvents$subscr.call(_MinimogEvents, 'ON_ITEM_ADDED', async item => {
        if (item && item.source !== 'incart-upsell') {
          ...
          if (res !== null && res !== void 0 && res.ok && res !== null && res !== void 0 && (_res$payload = res.payload) !== null && _res$payload !== void 0 && _res$payload.prePurchase && res !== null && res !== void 0 && (_res$payload2 = res.payload) !== null && _res$payload2 !== void 0 && (_res$payload2$prePurc = _res$payload2.prePurchase) !== null && _res$payload2$prePurc !== void 0 && _res$payload2$prePurc.recommended_products.length) {
            var _MinimogTheme, _MinimogTheme$Product, _res$payload3;
            (_MinimogTheme = pre_purchase_MinimogTheme) === null || _MinimogTheme === void 0 ? void 0 : (_MinimogTheme$Product = _MinimogTheme.ProductQuickView) === null || _MinimogTheme$Product === void 0 ? void 0 : _MinimogTheme$Product.close();
    ...
    (0,defineProperty/* default */.Z)(this, "getProductsJson", async () => {
      var _this$settings;
      this.products = await getProductsJSON((_this$settings = this.settings) === null || _this$settings === void 0 ? void 0 : _this$settings.recommended_products);
    });
